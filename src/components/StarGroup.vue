<template>
	<div class="c-StarGroup">
		<svg v-for="(star, index) in stars" :key="star"
			...
			<g id="Main-Copy-11" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
				transform="translate(-1221.000000, -143.000000)">
				<path d="M1226.50738,162.322754 L1232,159.435112 L1237.49262,162.322754
				...
				1226.50738,162.322754 Z" id="Star-Copy-6"></path>
			</g>
		</svg>
	</div>
</template>
